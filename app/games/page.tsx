  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-16">
      ...
      <div className="mb-12">
        ...
        <h1 className="text-4xl font-bold text-white mt-2">Games</h1>
        <p className="text-zinc-400 mt-3 max-w-2xl leading-relaxed">
          Mini Market Simulation, Dodge Master, KartBlitz, Blob Game — and
          more on the way.
        </p>
      </div>
      ...
      {projects.length > 0 ? (
        ...
        <div className="flex flex-col items-center justify-center py-32 text-center">
          ...
          <p className="text-zinc-400 text-lg">Games coming soon.</p>
        </div>
      )}
    </div>
  );
