  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-16">
      ...
      <div className="mb-12">
        ...
        <h1 className="text-4xl font-bold text-white mt-2">Backend / Tools</h1>
        <p className="text-zinc-400 mt-3 max-w-2xl leading-relaxed">
          AI hubs, APIs, utilities, and systems I&apos;ve built.
        </p>
      </div>
      ...
      {projects.length > 0 ? (
        ...
        <div className="flex flex-col items-center justify-center py-32 text-center">
          ...
          <p className="text-zinc-400 text-lg">Backend projects coming soon.</p>
        </div>
      )}
    </div>
  );
